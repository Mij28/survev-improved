...
export const Main: MapDef = {
    ...
    gameConfig: {
        planes: {
            ...
            crates: [
                ...
                { name: "airdrop_crate_mythic", weight: 0.25 },
            ],
        },
        bagSizes: {},
        bleedDamage: 2,
    ...
    lootTable: {
        ...
        tier_ammo_crate: [
            ...
            { name: "127mm", count: 7, weight: 0.25 },
        ...
        tier_eye_block: [
            ...
            { name: "tier_perks2", count: 1, weight: 1 },
        ],
        tier_eye_stone: [
            { name: "vector45", count: 1, weight: 1 },
            { name: "9mm", count: 1, weight: 1 },
            { name: "garand", count: 1, weight: 1 },
            { name: "svd",
                    count: 1,
                    weight: 1
        ...
        tier_police: [
            ...
            { name: "scarssr", count: 1, weight: 0.03 },
        ...
        tier_ring_case: [
            ...
            { name: "m79", count: 1, weight: 0.07 },
            { name: "rn50", count: 1, weight: 0.033 }, // ?
        ],
        tier_chest: [
            { name: "famas", count: 1, weight: 1.15 },
            { name: "m16", count: 1, weight: 1 },
            { name: "hk416", count: 1, weight: 4 },
            ...
            { name: "m79", count: 1, weight: 0.08 },
            { name: "m134", count: 1, weight: 0.06 },
        ...
        tier_case_blacksun: [
            { name: "mp220", count: 1, weight: 0.15 },
            { name: "hk416", count: 1, weight: 0.7 },
            { name: "deagle", count: 1, weight: 0.04 },
        ],
        tier_lmgs: [
        ...
        tier_perks2: [
         ...
         tier_blacksun: [
                ...
                { name: "katana_demo", count: 1, weight: 1},
                { name: "helmet03_moon", count: 1, weight: 1},
                {
                    name: "helmet03_forest",
                    count: 1,
                    weight: 0.1,
                },
                ...
                { name: "bizon", count: 1, weight: 1 },
                { name: "asval", count: 1, weight: 0.1 },
                ],
        tier_potato_perks: [
