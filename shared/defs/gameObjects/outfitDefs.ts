...
const SkinDefs: Record<string, OutfitDef> = {
    ...
    outfitCustom1: defineOutfitSkin("outfitBase", {
        name: "Custom Skin 1",
        skinImg: {
            baseTint: 16570998,
            baseSprite: "player-base-01.img",
            handTint: 0xffffff,
            handSprite: "player-hands-frostpunch.img",
            footTint: 5145457,
            footSprite: "player-feet-01.img",
            backpackTint: 7874075,
            backpackSprite: "player-circle-base-01.img",
        },
        lootImg: {
            sprite: "loot-shirt-01.img",
     ...
     outfitTrapped: {
        ...
        skinImg: {
            ...
            footTint: 16303476,
            footSprite: "player-feet-01.img",
            backpackTint: 2827032,
            backpackSprite: "player-circle-base-01.img",
            frontSpritePos: { x: -8, y: 0 },
            frontSprite: "player-accessory-trap.img"
        },
        lootImg: {
            sprite: "loot-shirt-outfitTrapped.img",
            tint: 0xffffff,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.2,
    ...
    outfitShen: defineOutfitSkin("outfitBase", {
        name: "Lord Shen",
        noDropOnDeath: true,
        rarity: 5,
        skinImg: {
            baseTint: 0xffffff,
            baseSprite: "player-base-shen.img",
            handTint: 15853800,
            handSprite: "player-hands-01.img",
            footTint: 15853800,
            footSprite: "player-feet-01.img",
            backpackTint: 11447211,
            backpackSprite: "player-circle-base-01.img",
            frontSpritePos: { x: -1, y: 0 },
            frontSprite: "player-accessory-shen.img"
        },
        lootImg: {
            sprite: "loot-outfitShen.img",
            tint: 0xffffff,
        },
    }),
    ...
    outfitGalaxy: defineOutfitSkin("outfitBase", {
        ...
        noDropOnDeath: true,
        rarity: 4,
        lore: "Kongregate will be pissed off.",
        skinImg: {
            bas22eTint: 0xffffff,
    ...
    outfitGalaxy2: defineOutfitSkin("outfitBase", {
        name: "Galaxy King, Mij Version",
        noDropOnDeath: true,
        rarity: 4,
        lore: "This skin was used by the creator of this server.",
        skinImg: {
            bas22eTint: 0xffffff,
            baseSprite: "player-base-outfitGalaxy.img",
            handTint: 0xffffff,
      ...
      outfitChromesis: defineOutfitSkin("outfitBase", {
        ...
        skinImg: {
            ...
            backpackTint: 0xffffff,
            backpackSprite: "player-back-chromesis.img",
    ...
    outfitFireball: defineOutfitSkin("outfitBase", {
        ...
        rarity: 4,
        lore: "The real ghillie suit for 50v50 players.",
    }),
