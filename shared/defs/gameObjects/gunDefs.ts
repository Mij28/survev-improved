...
export const GunDefs: Record<string, GunDef> = {
    ...
    ump9: {
        ...
        worldImg: {
            sprite: "gun-ump-01.img",
            scale: { x: 0.375, y: 0.325 },
            tint: 0xffffff,
        ...
        bulletCount: 1,
        burstCount: 3,
        bulletType: "bullet_ump45",
        bulletTypeBonus: "bullet_ump45_bonus",
        headshotMult: 2,
        speed: { equip: 0, attack: 0 },
        lootImg: {
            sprite: "loot-weapon-ump45.img",
            tint: 65280,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
    ...
    m16: {
        ...
        burstCount: 3,
        burstSounds: 1,
        bulletType: "bullet_m16",
        headshotMult: 2,
        speed: { equip: 0, attack: 0 },
        lootImg: {
            sprite: "loot-weapon-m16a2.img",
            tint: 65280,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
    ...
    m4: {
        ...
        shotSpread: 3,
        bulletCount: 1,
        bulletType: "bullet_m4",
        headshotMult: 2,
        speed: { equip: 0, attack: 0 },
        lootImg: {
            sprite: "loot-weapon-m4.img",
            tint: 65280,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
    ...
    pkm: {
        ...
        bulletTypeBonus: "bullet_pkm_bonus",
        headshotMult: 2,
    ...
    mkg45: {
        ...
        worldImg: {
            sprite: "gun-mkg-01.img",
            scale: { x: 0.5, y: 0.5 },
            tint: 0xffffff,
            leftHandOffset: { x: 7.2, y: 0 },
            recoil: 1.66,
        },
        particle: { shellScale: 1, shellOffset: 0.45 },
        sound: {
    ...
    rn50: {
        ...
        shotSpread: 0.5,
        bulletCount: 1,
        bulletType: "bullet_50",
        headshotMult: 1,
        speed: { equip: -1, attack: 0 },
        lootImg: {
            sprite: "loot-weapon-rn50.img",
            tint: 65280,
            border: "loot-circle-outer-01.img",
            borderTint: 0,
            scale: 0.3,
        ...
        worldImg: {
            sprite: "gun-rn50-01.img",
            scale: { x: 0.5, y: 0.45 },
            tint: 0xffffff,
            leftHandOffset: { x: 7, y: 0 },
            recoil: 2.66,
        },
        particle: { shellScale: 2, shellOffset: 0.6 },
        sound: {
            shoot: "m82_01",
            reload: "rn50_reload_01",
            pickup: "gun_pickup_01",
            empty: "empty_fire_02",
            deploy: "rn50_cycle_01",
        },
    },
    bugle: {
        name: "Bugle",
