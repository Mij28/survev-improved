...
export const MapObjectDefs: Record<string, MapObjectDef> = {
    ...
    case_03: createCase({
        ...
        case_perks: createCase({
        health: 140,
        map: { display: true, color: 4937572, scale: 1.5 },
        img: {
            sprite: "obstacle-case-perks.img",
            residue: "map-case-hatchet-res-02.img",
        },
        terrain: { grass: true, beach: false },
        loot: [tierLoot("tier_world", 3, 5),tierLoot("tier_perks2", 0, 1)],
        hitParticle: "blackChip",
    }),
    case_blacksun: createCase({
        health: 140,
        map: { display: true, color: 11207173, scale: 1.5 },
        img: {
            sprite: "obstacle-case-special.img",
            residue: "map-case-hatchet-res-03.img",
        },
        terrain: { grass: true, beach: false },
        loot: [tierLoot("tier_case_blacksun", 1, 1)],
        hitParticle: "blackChip",
    }),
    case_04: createCase({
        health: 140,
    ...
    crate_mythic: createCrate({
        ...
        loot: [
            ...
            tierLoot("tier_airdrop_armor", 1, 1),
            tierLoot("tier_medical", 2, 2),
            tierLoot("tier_class_crate_mythic", 1, 1),
            tierLoot("tier_airdrop_scopes", 1, 1),
            tierLoot("tier_airdrop_outfits", 1, 1),
            tierLoot("tier_airdrop_melee", 1, 1),
            tierLoot("tier_airdrop_ammo", 3, 3),
    ...
    airdrop_crate_01: createAirdrop({
        ...
        explodeParticle: "airdropCrate02",
         ...
         airdrop_crate_mythic: createAirdrop({
        button: {
            useImg: "map-airdrop-02.img",
            useParticle: "airdropCrate01",
            sound: { on: "airdrop_open_01", off: "" },
