...
const Sounds: Record<string, Record<string, SoundDef>> = {
    players: {
        ...
        m16_01: {
            path: "audio/guns/m16_01.mp3",
            volume: 1,
            maxInstances: 5,
        },
        m16a2_reload: {
            path: "audio/guns/m16a2_reload.mp3",
            volume: 1.5
        },
        m16a2_switch: {
            path: "audio/guns/m16a2_switch.mp3",
            volume: 1
        },
        m4_01: {
            path: "audio/guns/m4_01.mp3",
            volume: 2,
            maxInstances: 5,
        },
        ump45_01: {
            path: "audio/guns/ump45_01.mp3",
            volume: 1,
            maxInstances: 5,
        },
        asval_01: {
        ...
        rn50_reload_01  : {
            path: "audio/guns/rn50_reload_01.mp3",
            volume: 2,
        },
        xm_01: {
            path: "audio/guns/xm_01.mp3",
            volume: 1,
            maxInstances: 5,
        },
        xm_reload_01  : {
                    path: "audio/guns/xm_reload_01.mp3",
                    volume: 1,
        },
        rn50_cycle_01  : {
            path: "audio/guns/rn50_cycle_01.mp3",
            volume: 1,
        },
        m82_switch_01: {
                path: "audio/guns/m82_switch_01.mp3",
                volume: 1,
        },
        mgl_reload_01: {
            path: "audio/guns/mgl_reload_01.mp3",
            volume: 1,
        },
        m3_reload_01: {
            path: "audio/guns/m3_reload_01.mp3",
            volume: 1,
        },
        m3_01: {
            path: "audio/guns/m3_01.mp3",
            volume: 1,
            maxInstances: 5,
        },
        hawk_01: {
            path: "audio/guns/Hawk_12G.mp3",
            volume: 1,
            maxInstances: 5,
        },
        p30ls_01: {
                path: "audio/guns/P30LS.mp3",
                volume: 1,
                maxInstances: 5,
        },
        m870_01: {
